...
public class DateAndTimes {
    ...
    public static final ZonedDateTime
        ZDT_20150618_23073050 = ZonedDateTime.of(LDT_20150618_23073050, ZoneId.of("Europe/Paris"));

    public static final Date OLD_DATE_20150618 = Date.valueOf("2017-10-28");
    public static final Timestamp OLD_TIMESTAMP_20150618_23073050 = Timestamp.valueOf("2017-10-28 22:30:15.3");
}
