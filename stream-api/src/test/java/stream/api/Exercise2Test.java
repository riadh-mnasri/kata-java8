...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(Customer::getAge).sorted(Comparator.naturalOrder());
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (a1, a2)-> a2.compareTo(a1);
        Stream<Integer> sortedAgeStream = customerList.stream().map(c -> c.getAge()).sorted(descOrder);
    ...
    public void top3RichCustomer() {
        ...
        Stream<String> top3RichCustomerStream = customerList.stream().
                                                             sorted((c1, c2) -> c2.getBudget().compareTo(c1.getBudget()))
                                                             .map(c -> c.getName())
                                                             .limit(3);
